...
void initTeclat(){
    ...
    (TRISCbits.TRISC0 = TRISCbits.TRISC4 = TRISCbits.TRISC2 = 1);
    (TRISCbits.TRISC1 = TRISCbits.TRISC3 = TRISCbits.TRISC5 = TRISEbits.TRISE1 = 0);
    estat_teclat = 0;
    hi_ha_tecla = 0;
    caracters_escrits = -1;
    espera = 0;
...
unsigned char comprovaHiHaColumna (){
    ...
    if (PORTCbits.RC2 == 1){
        columna_polsada = 0x01;
        hi_ha_tecla = 1;
    }
    if (PORTCbits.RC0 == 1){
        columna_polsada = 0x02;
        hi_ha_tecla = 1;
    }
    if (PORTCbits.RC4 == 1){
        columna_polsada = 0x04;
        hi_ha_tecla = 1;
    }
