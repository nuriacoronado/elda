...
unsigned long TI_GetTics (unsigned long TimerHandle);
...
unsigned char MyPutString(char frase[]);
# 22 "LCD.c" 2
# 44 "LCD.c"
...
void LcInit(char rows, char columns) {
 ...
 RowAct = ColumnAct = 0;
 (TRISBbits.TRISB0 = TRISBbits.TRISB1 = TRISBbits.TRISB2 = 0);
 for (i = 0; i < 2; i++) {
  Espera(Timer, 100);
...
void Espera(unsigned char Timer, int ms) {
 TI_ResetTics(Timer);
 while(TI_GetTics(Timer) < (16 * ms));
}

void CantaPartAlta(char c) {
  (LATEbits.LATE0 = (c & 0x80 ? 1 : 0));
  (LATBbits.LATB5 = (c & 0x40 ? 1 : 0));
  (LATBbits.LATB4 = (c & 0x20 ? 1 : 0));
  (LATBbits.LATB3 = (c & 0x10 ? 1 : 0));
}

void CantaPartBaixa(char c) {
  (LATEbits.LATE0 = (c & 0x08 ? 1 : 0));
  (LATBbits.LATB5 = (c & 0x04 ? 1 : 0));
  (LATBbits.LATB4 = (c & 0x02 ? 1 : 0));
  (LATBbits.LATB3 = (c & 0x01 ? 1 : 0));
}

void CantaIR(char IR) {
 (TRISBbits.TRISB3 = TRISBbits.TRISB4 = TRISBbits.TRISB5 = TRISEbits.TRISE0 = 0);
 (LATBbits.LATB0 = 0);
 (LATBbits.LATB1 = 0);
 (LATBbits.LATB2 = 1);
 CantaPartAlta(IR);
 ...
 (LATBbits.LATB2 = 1);
 (LATBbits.LATB2 = 0);
 (TRISBbits.TRISB3 = TRISBbits.TRISB4 = TRISBbits.TRISB5 = TRISEbits.TRISE0 = 1);
}
...
void WaitForBusy(void) { char Busy;
 ...
 TI_ResetTics(Timer);
 do {
  (LATBbits.LATB2 = 1);(LATBbits.LATB2 = 1);
  Busy = (PORTEbits.RE0);
  (LATBbits.LATB2 = 0);
  (LATBbits.LATB2 = 0);
  (LATBbits.LATB2 = 1);(LATBbits.LATB2 = 1);
...
void EscriuPrimeraOrdre(char ordre) {
 ...
 (TRISBbits.TRISB3 = TRISBbits.TRISB4 = TRISBbits.TRISB5 = TRISEbits.TRISE0 = 0); (LATBbits.LATB0 = 0); (LATBbits.LATB1 = 0);
 (LATBbits.LATB2 = 1); (LATBbits.LATB2 = 1);
  (LATEbits.LATE0 = (ordre & 0x08 ? 1 : 0));
  (LATBbits.LATB5 = (ordre & 0x04 ? 1 : 0));
  (LATBbits.LATB4 = (ordre & 0x02 ? 1 : 0));
  (LATBbits.LATB3 = (ordre & 0x01 ? 1 : 0));
 (LATBbits.LATB2 = 0);
}
