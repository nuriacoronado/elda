...
#define SetD4_D7Sortida()		(TRISBbits.TRISB3 = TRISBbits.TRISB4 = TRISBbits.TRISB5 = TRISEbits.TRISE0 = 0)
#define SetD4_D7Entrada()		(TRISBbits.TRISB3 = TRISBbits.TRISB4 = TRISBbits.TRISB5 = TRISEbits.TRISE0 = 1)
#define SetControlsSortida()            (TRISBbits.TRISB0 = TRISBbits.TRISB1 = TRISBbits.TRISB2 = 0)
#define SetD4(On)				(LATBbits.LATB3 = (On))
#define SetD5(On)				(LATBbits.LATB4 = (On))
#define SetD6(On)				(LATBbits.LATB5 = (On))
#define SetD7(On)				(LATEbits.LATE0 = (On))
#define GetBusyFlag()                           (PORTEbits.RE0)
#define RSUp()					(LATBbits.LATB0 = 1)
#define RSDown()				(LATBbits.LATB0 = 0)
#define RWUp()					(LATBbits.LATB1 = 1)
#define RWDown()				(LATBbits.LATB1 = 0)
